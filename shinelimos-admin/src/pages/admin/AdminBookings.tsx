    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-white/60 text-sm mt-1">Manage and track your customer reservations.</p>
        </div>
        <div className="flex items-center gap-3">
          <div className="flex items-center bg-[#050505] border border-white/10 rounded-xl px-4 py-2 w-64 focus-within:border-purple-500/40 transition-all">
            ...
            <input 
              ...
              className="bg-transparent border-none outline-none text-sm text-white px-3 w-full placeholder:text-white/40"
            />
          </div>
        </div>
      </div>
      ...
      <div className="glass-dark rounded-2xl border border-white/10 overflow-hidden">
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-[11px] text-white/50">{b.contact_details?.booker?.email || "No email"}</div>
                        </div>
                      </div>
                    </td>
                    <td className="p-4 font-medium text-white">{b.vehicle_details?.vehicle_name || "N/A"}</td>
                    <td className="p-4 text-white/80">{b.trip_details[0]?.occasion || "N/A"}</td>
                    <td className="p-4 text-white/80">{b.trip_details[0]?.trip_type || "N/A"}</td>
                    <td className="p-4 text-white/80">{moment(b.created_at).format("DD MMM YYYY")}</td>
                    <td className="p-4">
        ...
        {filteredBookings.length > 0 && (
          <div className="p-4 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-white/70">
             <div>
             ...
             <div className="flex items-center gap-2">
                ...
                {[...Array(totalPages)].map((_, i) => (
                  <button 
                    ...
                    className={`w-8 h-8 rounded-lg flex items-center justify-center text-xs font-bold transition-colors ${currentPage === i + 1 ? 'bg-purple-600 text-white' : 'border border-white/10 hover:bg-white/5 text-white/80'}`}
                  >
                    {i + 1}
                  </button>
                ))}
      ...
      {arrivalModalBooking && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-xs animate-in fade-in duration-200 text-left">
          <div className="bg-[#121212] border border-white/10 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl">
            ...
            <div className="p-6 space-y-5">
              <div className="glass rounded-xl p-4 space-y-2 border border-white/5 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-purple-300 font-mono text-xs">{arrivalModalBooking.contact_details?.booker?.email}</span>
                </div>
                <div className="flex justify-between">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-2.5 text-white font-mono text-sm focus:outline-none focus:border-purple-500/60"
                    placeholder="0"
                  />
            ...
            <div className="p-5 border-t border-white/10 flex justify-end gap-3 bg-white/2">
              ...
              <button
                ...
                className="px-5 py-2 rounded-xl text-sm font-medium bg-purple-500 text-white hover:bg-purple-600 transition-all flex items-center gap-2 disabled:opacity-50 font-bold"
              >
      ...
      {finalModalBooking && (() => {
        ...
        return (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-xs animate-in fade-in duration-200 overflow-y-auto text-left">
